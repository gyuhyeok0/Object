...
public class MemberDTO {
    ...
    /*필기.
        설정자 stter 접근자 getter 의 경우 실무에서 암묵적으로 통용되는 작성 규칙이 존재한다.
        설정자 작성규칙
            ...
            필드에 접근해서 기록된 값을 return으로 반환하며, 이때 반환 타입은 값의 자료형과 일치
            [표현식]
        public 반환형 get필드명() {
        return 반환값;
        }
    ...
    /* 필기 boolean의 접근자는 get 으로 시작하지 않고 is로 시작 하는ㅁ 것이 일반적으로 관례이다. */
