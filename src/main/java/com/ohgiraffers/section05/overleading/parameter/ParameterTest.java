...
public class ParameterTest {
    ...
    public void testParmeterPrimaryTypeArray(int[] iarr) {
        ...
        System.out.print("변경 후 배열의 갋 출력");
    ...
    public void testParameterClassType(RectAngle rectAngle) {
        ...
        /*필기.
            인스턴스 주소가 전달된다.
            즉 인자로 전달하는 인스턴스와 매개변수로 전달 인스턴스는 동일한 인스턴스를 가리킨다. (얕은복사)
         */
    ...
    public void testVariableLengthArrayParameter (String name, String...hobby) {
        ...
        /* 필기.
            가변길이의 배열을 몇 개가 매개변수로 전달 될 지 모르는 상황이기 때문에 이름과
            구분하기 위해 뒤쪽에 작성해야한다.
